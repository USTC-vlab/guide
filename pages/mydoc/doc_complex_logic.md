...
{% include image.html file="complex_logic/1.png" %} 
...
{% include image.html file="complex_logic/2.jpg" %} 


{% include image.html file="complex_logic/3.jpg" %} 
...
{% include image.html file="complex_logic/4.png" %} 
### 实验步骤
